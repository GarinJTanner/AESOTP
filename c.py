...
class console(cmd.Cmd):
    ...
    def do_send(self, arg):
        ...
        try:
            key_length = int(input("\nKey length — Recommended minimum of 8. Maximum of 100 depending on the length of your message: "))
        except:
        ...
        try:
            ...
            print("Issue with creating Stripe token.")
        ...
        try:
            ...
            print("Too long. Damn it. 20,000 characters max for Stripe, but that doesn't mean the message length.  Try again.")
